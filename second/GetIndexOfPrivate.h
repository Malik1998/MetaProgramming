...
#ifndef SECOND_GETINDEXOFPRIVATE_H
#define SECOND_GETINDEXOFPRIVATE_H
...
struct GetIndexOf {
    int operator()() {
        return (GetIndexOfPrivate <typename T::head, typename T::tail, S > ()() < 0) ?
               -1 :
               GetIndexOfPrivate <typename T::head, typename T::tail, S > ()();
    }
};


#endif //SECOND_GETINDEXOFPRIVATE_H
